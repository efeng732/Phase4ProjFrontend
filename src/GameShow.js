...
function GameShow({ addRental, reviews, addReview, editReview, deleteReview}) {
...
if(duration * game.price > 100) {
   ...
   function handleReview(e) {
     ...
     function handleDeleteReview() {
         ...
         .then( res => res.json())
         .then(deleted => deleteReview(deleted))
     }
    ...
    <div>
        {game ? 
            ...
            <form onSubmit={handleRentGame} className="form">
               ...
               <input type="number" name="duration" placeholder="Choose time of rental" 
               value={duration}
            ...
            <div>
                <form onSubmit={handleEditReview}>
                    ...
                    <input type="text" name="title" placeholder="Review title here!"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    />
                    <br></br>
                    <label htmlFor="content">Review</label>
                    <input type="text" name="review" placeholder="This game sucks!"
                    value={content}
